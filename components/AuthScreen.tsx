    ...
    <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="flex items-center justify-center gap-2 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">
              ORÁCULO <span className="text-orange-600">CULTURAL</span>
            </h1>
            <p className="text-xs text-slate-500 font-bold uppercase tracking-widest">Content Factory</p>
          </div>
        </div>
        ...
        <p className="text-center text-slate-500 text-xs mt-6">
          Auth via Supabase. Cada usuário vê apenas seus produtos e histórico.
        </p>
      </div>
    </div>
  );
